	...
	<body>
		...
		<div class="first" >
			...
			<ul>
				...
				<li><input type="submit" value="goto Id" class="gotobutton" name="submit"><input type="text" class="search1" name="search1"/></li>
				<li ><input type="submit" value="search Text" class="searchbutton"><input type="text" class="search2" name="search2"/></li>
